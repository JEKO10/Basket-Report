      ...
      <form className="flex items-center justify-center flex-col bg-accent mt-2 px-8 pt-7 pb-5 rounded-lg">
        <div className="relative w-full mb-3">
          <input
            ...
            id="email"
            placeholder=" "
            className="peer w-full focus:pt-5 px-3 py-2 rounded-md outline-none transition-all duration-100 ease"
          />
          <label
            htmlFor="email"
            className="absolute left-3 text-md text-gray-500 transition-all duration-100 ease peer-placeholder-shown:top-1 peer-placeholder-shown:text-md peer-focus:top-0 peer-focus:text-xs peer-focus:text-blue-500 select-none py-1"
          >
            Vaše ime
          </label>
        </div>
        <div className="relative w-full mb-3">
          ...
          <label
            htmlFor="email"
            className="absolute left-3 top-0 text-md text-gray-500 transition-all duration-100 ease peer-placeholder-shown:top-1 peer-placeholder-shown:text-md peer-focus:top-0 peer-focus:text-xs peer-focus:text-blue-500 select-none py-1"
          >
            Vaša e-mail adresa
          </label>
        </div>
